...
def test_index_page_exposes_task_creation_form(ui_server):
    ...
    assert '<option value="">Use provider default model</option>' in html
    assert '<option value="gemini-2.5-flash">Gemini 2.5 Flash</option>' in html
    assert '<option value="gpt-5.4">GPT-5.4</option>' in html
    assert '<option value="litrpg-writer">litrpg-writer</option>' in html
    ...
    assert '<option value="edge">Edge default voice</option>' in html
    assert '<option value="gpt-4o-mini-tts">GPT-4o Mini TTS</option>' in html
    assert '<option value="eleven_multilingual_v2">Eleven Multilingual v2</option>' in html
    assert '<option value="gemini-2.5-flash-preview-tts">Gemini 2.5 Flash Preview TTS</option>' in html
